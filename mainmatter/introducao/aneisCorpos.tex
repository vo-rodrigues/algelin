...
\begin{definition}
Um \emph{anel} \index{anel} é um conjunto $A$ munido de duas operações binárias, geralmente denotadas por $+$ e $\cdot$, e por dois elementos destacados, geralmente denotados por $0$ e $1$, tais que, para todos $a, b, c \in A$, valem:
\begin{itemize}
...
\end{itemize}
então dizemos que $A$ é um \emph{anel comutativo}\index{anel!comutativo}.
\end{definition}
...
Assim, podemos dar um nome especial para o oposto aditivo de um elemento $a \in A$:
